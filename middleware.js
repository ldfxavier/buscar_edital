...
export function middleware(request) {
  ...
  // Permite chamadas automáticas do Vercel Cron
  ...
  const expectedToken = `xm_session_${secret}`;
  const isAuthenticated = Boolean(sessionCookie && sessionCookie.value === expectedToken);
